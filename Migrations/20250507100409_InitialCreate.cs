    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExamUser", x => new { x.ExamsId, x.UsersUserId });
                    table.ForeignKey(
                        name: "FK_ExamUser_Exams_ExamsId",
                        column: x => x.ExamsId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExamId = table.Column<int>(type: "int", nullable: false),
                    Id = table.Column<int>(type: "int", nullable: false),
                    UserKeyAnswerPdffile = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
